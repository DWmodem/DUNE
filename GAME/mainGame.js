...
var mapGen = new Phaser.Class({
	...
	var startCheck = true;
	var stormCheck = false;
	var spiceBlowCheck = false;
	var biddingCheck = false;
	var movementCheck = false;
	var battlesCheck = false;
	var spiceCollectionCheck = false;
	var briberyCheck  = false;
	var miscCheck = false;

	var continueText = this.add.text(850, 50, "Start", { fontSize: "40px", fill: "000"}).setInteractive();;
	...
	continueText.on('pointerdown', function() {
		...
		startCheck = false;
		storm();
	    }else if(stormCheck == true){

		stormCheck = false;
		spiceBlow();

	    }else if(spiceBlowCheck == true){

		spiceBlowCheck = false;
		bidding();
		
	    }else if(biddingCheck == true){

		biddingCheck = false;
		movement();
		
	    }else if(movementCheck == true){

		movementCheck = false;
		battles();
		
	    }else if(battlesCheck == true){

		battlesCheck = false;
		spiceCollection();
		
	    }else if(spiceCollectionCheck == true){

		spiceCollectionCheck = false;
		bribery();
		
	    }else if(briberyCheck == true){

		briberyCheck = false;
		misc();
		
	    }else if(miscCheck =- true){
	...
	var spiceBlow = function(){
	    continueText.visible = false;
	    spiceBlowCheck = true;
	    console.log("spiceBlow");
	    continueText.visible = true;
	};
	...
	var spiceCollection = function(){
	    continueText.visible = false;
	    spiceCollectionCheck = true;
	    console.log("spiceCollection");
	    continueText.visible = true;
	};

	var bribery = function(){
	    continueText.visible = false;
	    briberyCheck = true;
	    console.log("bribery");
	    continueText.visible = true;
	...
	//4:Move storm
	var stormSprite = this.add.sprite(337,910, "Storm");
